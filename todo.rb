class Todo < Formula
  ...
  if OS.mac?
    url "https://github.com/dvkt/ldpl-todo/releases/download/v1.0.0/todo-v1.0.0-macos.zip"
    sha256 "f6b2e8c007b3cbd6143bab2fba2b32b44e63063800e3c48acef72f5cd32b8732"
  elsif OS.linux?
    url "https://github.com/dvkt/ldpl-todo/releases/download/v1.0.0/todo-v1.0.0-linux-x86_64.tar.gz"
