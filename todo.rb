class Todo < Formula
  ...
  if OS.mac?
    url "https://github.com/dvkt/ldpl-todo/releases/download/v1.0.1/todo-v1.0.1-macos.zip"
    sha256 "30ce1e510275e923fc69fa271a48c44d0e56adf44ce0ba55cbe0c211926cbb90"
  elsif OS.linux?
    url "https://github.com/dvkt/ldpl-todo/releases/download/v1.0.1/todo-v1.0.1-linux-x86_64.tar.gz"
