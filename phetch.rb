class Phetch < Formula
  ...
  if OS.mac?
    url "https://github.com/xvxx/phetch/releases/download/v0.1.12/phetch-v0.1.12-macos.zip"
    sha256 "b3f786b577b73c4437f2b64e5a2ed43a19c6ae2db15a04ff111b45341e2de4ed"
  elsif OS.linux?
    url "https://github.com/xvxx/phetch/releases/download/v0.1.12/phetch-v0.1.12-linux-x86_64.tgz"
